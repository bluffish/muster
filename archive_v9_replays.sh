...
source_directory=/home/ubuntu/muster-local-hex/runs/local-hex-v9-side-equivariant-v1/replays
archive_directory=/srv/muster-archive/local-hex-v9-side-equivariant-v1/replays
