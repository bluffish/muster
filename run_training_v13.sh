...
run_dir=runs/local-hex-v13-selfplay-v1
...
args=(
    ...
    --anchor-episodes 4
    --log-std-floor -0.8
    --warm-start runs/local-hex-v12-clock-v1/latest.pt
    --reset-log-std
    --dtype bf16
    --compile
    ...
    --wandb-name bowen3-v13-selfplay-v1
    --wandb-id bowen3-v13-selfplay-v1
    --seed 0
)
